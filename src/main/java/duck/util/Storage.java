...
/**
 * Handles I/O between Duck and an external cache file. Storage instances can load the
...
public class Storage {
     ...
     */
    public void initializeCacheIfNotExists() throws DuckException {
     ...
     * @throws DuckException    If unable to write to archive file
     */
    public void writeArchive(ArrayList<Task> taskArrayList) throws DuckException {
        try {
            ...
            throw new DuckException(ARCHIVE_WRITE_FAILED);
        }
    }
}
