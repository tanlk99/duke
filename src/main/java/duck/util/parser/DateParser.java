...
/**
 * Parses dates in Duck's commands.
 */
class DateParser {
     ...
     * If there was no suitable format, throws a {@link DuckException}.
     *
     * @param   rawTime Substring of command representing a time
     * @return  A {@link Calendar} object if the command can be parsed
     * @throws  DuckException   If command cannot be parsed
     */
    Calendar parseTime(String rawTime) throws DuckException {
        ...
        throw new DuckException(INTERNAL_DATE_FORMAT_NOT_FOUND);
    }
}
