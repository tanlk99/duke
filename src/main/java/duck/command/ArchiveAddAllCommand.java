...
public class ArchiveAddAllCommand extends ArchiveAddCommand {
    private static final String ARCHIVE_ADD_ALL_COMMAND_EMPTY_TASK_LIST =
            "You have no tasks in your task list right now.";
    ...
    public void execute(StorageHandler cacheHandler, StorageHandler archiveHandler, Buffer buffer, TaskList taskList,
        ...
        if (size == 0) {
            buffer.formatLine(ARCHIVE_ADD_ALL_COMMAND_EMPTY_TASK_LIST);
            return;
        }
