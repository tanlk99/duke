...
class DialogBox extends HBox {
    private static final String DUKE_DIALOG_BOX_ID = "duck-dialog-box";
    ...
    /**
     * Creates a dialog box for messages from Duck.
     ...
     * @return      A DialogBox object for the message
     */
    static DialogBox getDuckDialog(String text, Image img) {
        DialogBox db = new DialogBox(text, img);
