...
class Config {
    private static final String DEFAULT_CACHE_PATH = "data/duke-cache.txt";
    private static final String DEFAULT_ARCHIVE_PATH = "archive/duke-archive.txt";

    private String cachePath;
    private String archivePath;

    /**
     * Returns a Config object containing Duke's default configuration.
     *
