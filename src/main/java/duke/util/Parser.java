...
public class Parser {
     ...
     * Below is a table of all accepted commands:
     *
     * <table border="1">
     ...
     *   <tr>
     *     <td>list</td>
     *     <td>List all the events in order indicating their completion status, type, and time (if applicable).
     *   </tr>
     *   <tr>
     *     <td>done <i>index</i></td>
     *     <td>Mark the <i>index</i>-th task in the task list as complete (<i>index</i> must be a valid integer).
     *   </tr>
     *   <tr>
     *     <td>delete <i>index</i></td>
     *     <td>Delete the <i>index</i>-th task in the task list (<i>index</i> must be a valid integer).
     *   </tr>
     *   <tr>
     *     <td>bye</td>
     *     <td>Exit Duke.</td>
